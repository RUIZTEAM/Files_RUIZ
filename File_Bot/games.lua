...
send(msg.chat_id_, msg.id_, "*✦︙تم اضافة له* {"..numadded..'} من النقود')  
end
...
database:incrby(bot_id..'TeLaNd:messageUser'..msg.chat_id_..':'..msg.sender_user_id_,NUMNKO)  
